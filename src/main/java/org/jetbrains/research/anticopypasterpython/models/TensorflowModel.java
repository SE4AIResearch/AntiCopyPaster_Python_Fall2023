...
public class TensorflowModel extends PredictionModel {
    ...
    private static SavedModelBundle loadModel(String modelResourcePath) {
        ...
        tmp = tmp.replace("AntiCopyPaster_Python_Fall2023","anti-copy-paster-master");
        target = Paths.get(tmp);
    ...
    public static boolean copyFromJar(String source, final Path target) {
        System.out.println(TensorflowModel.class.getClassLoader());
        System.out.println(TensorflowModel.class.getClassLoader().getResource(source));
