...
public class AdvancedProjectSettingsComponent {
    ...
    public void setActiveKeywords(EnumMap<PythonKeywords, Boolean> active) {
        ...
        asCheckBox.setSelected(active.get(PythonKeywords.ASSERT));
        asyncCheckBox.setSelected(active.get(PythonKeywords.ASYNC));
        awaitCheckBox.setSelected(active.get(PythonKeywords.AWAIT));
        continueCheckBox.setSelected(active.get(PythonKeywords.BREAK));
        continueCheckBox.setSelected(active.get(PythonKeywords.CLASS));
        falseCheckBox.setSelected(active.get(PythonKeywords.CONTINUE));
        ...
        nonlocalCheckBox.setSelected(active.get(PythonKeywords.FINALLY));
        noneCheckBox.setSelected(active.get(PythonKeywords.FOR));
        fromCheckBox.setSelected(active.get(PythonKeywords.FROM));
        globalCheckBox.setSelected(active.get(PythonKeywords.GLOBAL));
        breakCheckBox.setSelected(active.get(PythonKeywords.IF));
        ...
        forCheckBox.setSelected(active.get(PythonKeywords.RETURN));
//        inCheckBox.setSelected(active.get(PythonKeywords.TRY));
//        returnCheckBox.setSelected(active.get(PythonKeywords.WHILE));
